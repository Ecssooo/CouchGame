...
UCLASS(Config=Game, DefaultConfig, meta=(DisplayName="LocalMultiplayerSettings"))
...
public:
	...
	FLocalMultiplayerProfileData FindKeyboardProfileFromIndex(int PlayerIndex) const;
