...
protected:
	...
	UPROPERTY()
	TMap<int, int> PlayerIndexFromKeyboardProfileIndex; //Key : KeyboardProfile; Value : PlayerIndex 

	UPROPERTY()
	TMap<int, int> PlayerIndexFromGamepadProfileIndex; //Key : GamepadProfile; Value : PlayerIndex 
};
